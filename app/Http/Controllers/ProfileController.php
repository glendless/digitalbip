...
class ProfileController extends Controller
{
    ...
    public function index() {
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data Profil Berhasil Diambil', new ProfileResource($profile), 200);
        } catch (\Exception $e) {
    ...
    public function store(ProfileStoreRequest $request) {
     ...
     public function update(ProfileUpdateRequest $request) {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data Profil Berhasil Diperbarui', new ProfileResource($profile), 200);
